    ...
    <>
      <section className="shoppingCart">
        <div className="shoppingCart-shoppingList">
          {json.productList.map(({ id, nombre, precio, img, descripcion }) => (
            <Product
              id={id}
              precio={precio}
              imgSrc={img}
